...
expname = 'paper_imp_open_vit16_240'# experiment name
...
data = dict(
    ...
    resolution=240,               # Training time render resolution
...
fine_train.update(dict(
    ...
    pg_scale=\
        [5000, 7000, 9000, 11000],# checkpoints for progressive scaling
    ...
    clip_model_name =\
        'ViT-B-16-plus-240',      # ['RN50', 'RN101', 'RN50x4', 'RN50x16', 'RN50x64', 'ViT-B/32', 'ViT-B/16', 'ViT-L/14', 'ViT-L/14@336px']
    clip_mode_res = 240,
    clip_model_start = 0,
    ...
    query_text="matte painting of a bonsai tree; trending on artstation.",
))
